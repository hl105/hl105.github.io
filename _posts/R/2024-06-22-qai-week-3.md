...
All code and lecture notes from the QAI Program. 
...
4. Normality
	1. 
		...
		![](./assets/images/banners/Screenshot_2024-06-21_at_7.07.16_PM.png)


		![](./assets/images/banners/Screenshot_2024-06-21_at_7.08.42_PM.png)
...
1. Equal population variances
	...
	![](./assets/images/banners/Screenshot_2024-06-21_at_7.12.17_PM.png)
...
2. Outliers
	1. 
		...
		![](./assets/images/banners/Screenshot_2024-06-21_at_7.16.51_PM.png)

	2. 

		![](./assets/images/banners/Screenshot_2024-06-21_at_7.17.18_PM.png)
...
3. small samples
	1. use permulation test
		...
		![](./assets/images/banners/Screenshot_2024-06-21_at_7.18.55_PM.png)

	2. permutation test just cares if the distributions look the same

		![](./assets/images/banners/Screenshot_2024-06-21_at_7.19.11_PM.png)
...
1. Why use log transformations & Interpreting a diff in mean logs on the original scale
	...
	3. Take log! Will look approximately normal now
		...
		![](./assets/images/banners/Screenshot_2024-06-21_at_9.25.36_PM.png)
